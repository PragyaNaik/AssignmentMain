...
namespace StudentWebApp
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        private void DefaultEmpRecord()
        {
            ...
            dt.Columns.Add(new DataColumn("RollNum", typeof(string)));
            ...
            if (ViewState["StudentDetails"] != null)
            {
                ...
                if (dtCurrentTable.Rows.Count > 0)
                {
                    for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                    {
                        ...
                        drCurrentRow["RollNum"] = txtRollNumber.Text;
                        drCurrentRow["Age"] = txtAge.Text;
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            for (int i = 0; i < GridView1.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    RollNum = ((TextBox)row.Cells[2].Controls[0]).Text;
